...
export class NavbarComponent {
  ...
  menuItems = [
    ...
    { label: 'Ajouter un checker', route: '/register', roles: ['checker'] },
    { label: 'Vérifier un numéro', route: '/verifier', auth: true },
    { label: 'Historique', route: '/historique', auth: true , roles: ['checker']},
    ...
    { label: 'Trajets', route: '/trajets', auth: true, roles: ['admin', 'checker', 'compagnie'] },
    { label: 'Vehicules', route: '/vehicules', auth: true, roles: ['admin', 'checker', 'compagnie'] },
    { label: 'Type de vehicules', route: '/param/types-vehicules', auth: true, roles: ['admin', 'checker', 'compagnie'] },
    { label: 'Aide', route: '/aide', auth: false },
    { label: 'Axes', route: '/axes', auth: true, roles: ['admin', 'checker', 'compagnie'] },
    { label: 'Passagers', route: '/passagers', auth: true, roles: ['admin', 'checker', 'compagnie'] },
