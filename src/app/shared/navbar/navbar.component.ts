...
export class NavbarComponent {
  ...
  menuItems = [
    ...
    { label: 'Trajets', route: '/trajets', auth: true, roles: ['admin', 'compagnie'] },
    { label: 'Trajets', route: 'checker/trajets', auth: true, roles: ['checker', 'compagnie'] },
    { label: 'Vehicules', route: '/vehicules', auth: true, roles: ['admin', 'compagnie'] },
